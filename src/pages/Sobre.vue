<template>
  <q-page class="container">
    <div class="bg-accent q-pb-lg">
        <div class="row q-mx-xl text-justify">
            <div class="col-5 q-py-xl q-my-xl">
    ...
    <div class="row bg-grey-12">
        ...
        <div class="row q-mx-xl">
            <h1 class="text-h3 text-weight-bolder text-primary">
                A Etnia Awaete
            </h1>
        </div>
...
.grafismo {
  height: 75px;
  background-image: url("~assets/grafismo2.svg");
